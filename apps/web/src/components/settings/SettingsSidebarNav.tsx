...
import { ArchiveIcon, ArrowLeftIcon, Settings2Icon, UsersIcon } from "lucide-react";
...
export type SettingsSectionPath = "/settings/general" | "/settings/archived" | "/settings/users";
